...
const routing = RouterModule.forChild([
    ...
    { path: 'main', component: AdminComponent, canActivate: [AuthGuard],
        children: [
            ...
            { path: 'orders/:mode', component: OrderEditorComponent, data: {title: 'Add Table'}, canActivate: [AuthGuard]},
...
@NgModule({
    ...
    providers:[AuthGuard],
    declarations: [AuthComponent, AdminComponent, OrderTableComponent, BookEditorComponent, BookTableComponent, OrderEditorComponent]
})
